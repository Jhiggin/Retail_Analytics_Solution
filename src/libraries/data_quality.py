...
class DataQualityValidator:
    """
    Class for performing data quality validations on DataFrames
    """
    ...
    def check_value_range(self, column: str, min_value: Optional[float] = None, 
    ...
    def check_referential_integrity(self, foreign_key: str, reference_df: DataFrame, 
        ...
        """
        orphaned = (self.df.select(foreign_key)
                   .subtract(reference_df.select(reference_key))
                   .count())
